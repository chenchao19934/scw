...
export default {
    ...
    methods : {
        ...
        afterEnter(el){ 
            ...
            el.style.webkitTransition = `transform 0.66s cubic-bezier(${this.cubic})`;
            el.style.transition = `transform 0.66s cubic-bezier(${this.cubic})`;

            el.children[0].style.webkitTransition = 'transform 0.66s ease-out';
            el.children[0].style.transition = 'transform 0.66s ease-out';
