  ...
  <div class="wx-orderItem">
    ...
    <div class="wx-orderItem__content">
      ...
      <p class="wx-orderItem__contentItem">
        ...
        <span class="wx-orderItem__itemContent">{{ order.intime }}</span>
      </p>
      <p class="wx-orderItem__contentItem">
      ...
      <p class="wx-orderItem__contentItem">
        ...
        <span class="wx-orderItem__itemContent">{{order.status == 1 ? '审核中': order.status==2&&order.state==1 ? '通过':order.status==2&&order.state!=1? '不通过，请按要求重新上传正确的消费凭证':''}}</span>
      </p>
      <p class="wx-orderItem__contentItem">
