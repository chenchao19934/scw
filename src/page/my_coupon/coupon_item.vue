<template>
    <div class="wx-couobj clearfix">
        <div class="wx-couobj__img" :class="{'dt-red':obj.coupon_type === 20,'dt-yellow':obj.coupon_type === 10,'dt-green':obj.coupon_type === 30,'coupon-user':obj.lnvalid}">
