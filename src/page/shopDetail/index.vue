<template>
  <div class="wx-shopDetail"
    ...
    <Banner class="banner-image">
      <img :src="`http://woxfile.oss-cn-shenzhen.aliyuncs.com/uploadfile/article/${shopInfo.entityPath ? shopInfo.entityPath : shopInfo.shopDefaultPic}`" alt="" slot="bannerImg">
    </Banner>

    <!-- 信息摘要 -->
    <div class="wx-shopBrief bg-white">
      <div class="wx-shopBrief__imgWrap">
        <img :src="`http://woxfile.oss-cn-shenzhen.aliyuncs.com/uploadfile/article/${shopInfo.logoPath}`" alt="">
      </div>
